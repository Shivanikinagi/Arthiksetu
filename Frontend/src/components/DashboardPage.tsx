...
export function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Banner */}
      <div className="bg-[#1e3a5f] text-white shadow-md">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-blue-200 mb-2 uppercase tracking-wide">Total Monthly Earnings</p>
              <h1 className="text-6xl font-bold mb-2 tracking-tight">
                ₹{totalEarnings.toLocaleString('en-IN')}
              </h1>
              <p className="text-sm text-blue-100 flex items-center gap-1 font-light">
            ...
            <div>
              <Button
                ...
                className="bg-[#ff8c42] hover:bg-[#ff7a2e] text-white px-8 py-3.5 text-sm font-semibold rounded-lg transition-all flex items-center gap-2 shadow-lg hover:shadow-xl transform hover:scale-105"
                disabled={uploading}
              >
                {uploading ? (
                  <>
